...
//        BoardGeneration.initFromFEN("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
//        Calculation.init();
...
//        Image chessPieces = new ImageIcon("C:\\Users\\84905\\Documents\\chesspbl\\chess\\ChessEngine\\src\\main\\java\\com\\example\\chessengine\\chessProcessing\\ChessPieces.png").getImage();
//        for (int i = 0; i < 64; i++) {
//            int j = -1, k = -1;
//            if (((WP >> i) & 1) == 1) {
//                j = 5;
